...
@Override
    ...
    public boolean doAction(String[] inputs) {
      ...
      switch (menuItem) {
          ...
          break;
          case "Q" : return true;
          default: ErrorView.display(this.getClass().getName(),"Please enter a valid option.");
      }
    ...
    private void howToMove() {
        this.console.println("N - Travel North\n" +
"  W - Travel West\n" +
"  E - Travel East\n" +
"  S - Travel South" + "The user will enter one of the four directions to travel.");
    ...
    private void playCombat() {
        this.console.println("During combat the user will be able to see both ships stats and decide to attack or run. "
    ...
    private void savingGame() {
        this.console.println("The end user is prompted by the program to determine where the game will be saved. "
    ...
    private void restartingGame() {
        this.console.println("The end user is prompted to enter the file location where the game was saved previously. "
